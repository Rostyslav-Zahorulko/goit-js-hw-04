...
function reduceArray(array, cb, initial) {
  ...
  console.log(`Количество переданных в функцию аргументов:`, arguments.length);
  ...
  for (i; i < array.length; i += 1) {
    ...
    console.log('accum =', accum);
    console.log(`Элемент массива с индексом ${i}:`, element);
    console.log(
      'Результат исполнения callback функции:',
